-- HRD JAYATEMPO Database Schema for Supabase (PRODUCTION)
-- This file contains the complete system structure without demo data.
...
-- Create basic policies (Allow all for internal use - Adjust for multi-tenant if needed later)
...
('Gudang Utama', 'Jl. Raya Industri', 'Gudang utama untuk penyimpanan', 'active')
ON CONFLICT (name) DO NOTHING;
