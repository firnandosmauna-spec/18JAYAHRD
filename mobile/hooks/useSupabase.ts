...
import type { Employee, Department, LeaveRequest, AttendanceRecord, PayrollRecord, RewardRecord, NotificationRecord } from '../lib/supabase'
    ...
    const fetchAttendance = async () => {
        try {
            ...
            const data = startDate && endDate
                ? await attendanceService.getByDateRange(startDate, endDate)
                : await attendanceService.getByDateRange(
